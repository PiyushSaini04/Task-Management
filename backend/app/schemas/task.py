...
class TaskBase(BaseModel):
    ...
    category: Optional[str] = Field(default=None, max_length=50, description="Optional category or tag label")
    due_date: Optional[datetime] = Field(default=None, description="Optional timezone-aware due date")
